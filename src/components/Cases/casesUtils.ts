...
export function mapFirestoreCase(
  ...
  return {
    ...
    consentAttached: data.consentAttached === true,
    consentFileName: data.consentFileName ?? null,
    consentContentType: data.consentContentType ?? null,
    consentUploadedAt: data.consentUploadedAt?.toDate?.() ?? null,
    consentUploadedByName: data.consentUploadedByName ?? null,
