...
export const t = {
  ...
  dashboard: {
    ...
    sessionRoadNodeDone: 'finalizată',
    sessionRoadNodeNext: 'următoarea',
    sessionRoadNodeOpen: 'planificată',
    sessionRoadHiddenDone: '{n} sesiuni anterioare',
    sessionRoadDoneTooltip: 'Sesiune finalizată. Raport adăugat.',
    sessionRoadNextTitle: 'Sesiunea {n} · următoarea',
    sessionRoadFutureTitle: 'Sesiunea {n} · viitoare',
    sessionRoadUnscheduled: 'Neprogramată',
    sessionRoadNoAppointment: 'Nicio întâlnire programată',
    sessionRoadScheduledFor: 'Programată {when}',
    sessionRoadScheduleCta: 'Programează întâlnire',
    sessionRoadOpenReport: 'Vezi raportul',
    viewCase: 'Vezi',
    notes: 'Note',
    ...
    caseSelectionCountSingular: '1 caz disponibil',
    caseSelectionCountPlural: '{n} cazuri disponibile',
    caseSelectionSearch: 'Caută după persoană sau caz...',
    caseSelectionNoMatch: 'Niciun caz nu corespunde căutării'
  },
  ...
  cases: {
    ...
    editFormSubtitle: 'Actualizează statusul, tipul problemei și descrierea',
    createFormSubtitle: 'Completează detaliile cazului nou',
    sectionAssignment: 'Alocare',
    deleteCase: 'Șterge Caz',
    ...
    createdLabel: 'Creat',
    updated: 'Actualizat',
    viewAllNotes: 'Vezi ultimele note',
  ...
  appointments: {
    ...
    searchLabel: 'Căutare',
    scheduleAppointment: 'Programează Întâlnirea',
    formSubtitle: 'Completează detaliile întâlnirii',
    sectionDetails: 'Detalii',
    sectionSchedule: 'Data și ora',
    ...
    nextSession: 'următoarea',
    sessionOptionalHint: 'Opțional · implicit este selectată următoarea sesiune',
    room: 'Sala',
    client: 'Client',
    counselor: 'Consilier',
    description: 'Descriere',
    ...
    saveError: 'Eroare la salvarea programării',
  ...
  events: {
    ...
    formSubtitle: 'Completează detaliile evenimentului',
    sectionDetails: 'Detalii',
    sectionSchedule: 'Data și ora',
    sectionRegistration: 'Înscriere',
  ...
  sessionReports: {
    ...
    wizard: {
      title: 'Adaugă raport',
      stepContext: 'Context',
      stepTheme: 'Temă & răspuns',
      stepProgress: 'Progres',
      stepLabel: 'Pasul {n}',
      forward: 'Înainte',
      saveReport: 'Salvează raport',
      sessionNumber: 'Numărul sesiunii',
      frequencyPlaceholder: 'Selectează frecvența',
      mainTheme: 'Care a fost tema principală abordată?',
      mainThemeHint: 'ex: iertare, relații, frică, identitate, decizii practice etc.',
      mainThemePlaceholder: 'Introdu tema principală...',
      personResponse: 'Răspunsul persoanei consiliate',
      personResponseHint: 'ex: receptivă / rezervată / confuză / hotărâtă etc.',
      personResponsePlaceholder: 'Descrie răspunsul persoanei...',
      previousTask: 'Tema anterioară împlinită?',
      previousTaskHint: 'ex: da, parțial, nu – o scurtă observație despre motiv',
      previousTaskReasonPlaceholder:
        'Te rugăm să explici motivul pentru care tema nu a fost împlinită...',
      previousTaskReasonRequired:
        'Te rugăm să completezi motivul pentru care tema nu a fost împlinită',
      partial: 'Parțial',
      progress: 'Progres observat',
      progressHint: 'spiritual, emoțional, relațional, în atitudine sau în acțiune',
      progressPlaceholder: 'Descrie progresul observat...',
      commitments: 'Angajamente pentru următoarea întâlnire?',
      commitmentsHint:
        'ex: rugăciune specifică, studiu, confruntare, decizie, acțiune concretă etc.',
      commitmentsDetailsPlaceholder:
        'Descrie angajamentele pentru următoarea sesiune...',
      commitmentsDetailsRequired: 'Descrie angajamentele pentru următoarea sesiune',
      noCommitmentsReasonPlaceholder: 'De ce nu există angajamente?',
      noCommitmentsReasonRequired: 'Explică de ce nu există angajamente',
  ...
  profile: {
    ...
    formSubtitle: 'Actualizează datele de contact',
    editSpecialties: 'Editează specializări',
    specialtiesFormSubtitle: 'Adaugă sau elimină domeniile tale de expertiză',
  ...
  admin: {
    ...
    tabs: {
      ...
      receivedReports: 'Rapoarte lunare',
    ...
    users: {
      ...
      adminsCannotModifyLeaders: 'Coordonatorii nu pot modifica conturile liderilor',
      ...
      adminsCannotDeactivateLeaders: 'Coordonatorii nu pot dezactiva lideri',
  ...
  roles: {
    ...
    leader: 'Lider',
    leaderDescription: {
      createUsers: 'Creează utilizatori noi cu orice rol (lider, coordonator, consilier)',
  ...
  meetingNotes: {
    ...
    content: 'Conținut',
    contentPlaceholder:
      'Descrie cum s-a desfășurat întâlnirea, ce progres a fost făcut, observații importante...',
    sessionField: 'Sesiune',
    sessionLabel: 'Sesiune {n}',
    sessionInProgress: 'Sesiune {n} (în curs)',
    noSession: 'Fără sesiune',
    showingLatest: 'ultimele {n}',
    viewAllOnPage: 'Vezi toate pe Note de ședință',
    searchPlaceholder: 'Caută după nume, titlu caz…',
    casesList: 'Cazuri',
    selectCase: 'Selectează un caz pentru a vedea notele',
    noCases: 'Nu există cazuri pentru filtrele selectate',
    noNotesForSession: 'Nu există note pentru această sesiune',
    noteSingular: 'notă',
    notePlural: 'note',
    loadError: 'Eroare la încărcarea notelor de ședință',
    ...
    viewAllNotes: 'Vezi ultimele note',
    viewLatestNotes: 'Vezi ultimele note',
  ...
  resources: {
    ...
    addSubfolder: 'Adaugă subfolder',
    addLink: 'Adaugă link',
    editFolder: 'Editează folder',
    editSubfolder: 'Editează subfolder',
    editLink: 'Editează link',
    folderName: 'Nume folder',
    subfolderName: 'Nume subfolder',
    parentFolder: 'Folder părinte',
    rootFolder: 'Folder rădăcină',
    allowCounselors: 'Vizibil pentru consilieri',
    allowAdmins: 'Vizibil pentru coordonatori',
    ...
    linkOpensExternal: 'Linkul se deschide într-o filă nouă în Google.',
    openInGoogle: 'Deschide în Google',
    empty: 'Nu există resurse vizibile',
    emptyHint: 'Când liderul sau coordonatorul adaugă foldere și linkuri, le vei vedea aici.',
    emptyFolder: 'Niciun link în acest folder',
    loadError: 'Eroare la încărcarea resurselor',
    saveError: 'Eroare la salvare',
    folderNameRequired: 'Numele folderului este obligatoriu',
    linkTitleRequired: 'Titlul este obligatoriu',
    invalidUrl: 'Introdu un URL valid (http sau https)',
    invalidParent: 'Folderul părinte selectat nu este valid',
    folderRequired: 'Selectează un folder',
    deleteFolderTitle: 'Șterge folder',
    deleteFolderConfirm: 'Sigur vrei să ștergi folderul „{name}”?',
    deleteFolderWarning: 'Subfolderele și toate linkurile din interior vor fi șterse definitiv.',
    deleteLinkTitle: 'Șterge link',
    deleteLinkConfirm: 'Sigur vrei să ștergi linkul „{name}”?',
    chipCounselors: 'Consilieri',
    chipAdmins: 'Coordonatori',
